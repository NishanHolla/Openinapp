        ...
        return(
            <div className="flex h-screen w-screen">
                ...
                <div className="h-full w-4/6 pl-60 pt-64">
                    ...
                    <div className="flex w-44 h-8 bg-white border rounded-lg p-2 mt-5">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-4">
                        ...
                        <h1 className="ml-2 text-xs text-slate-400">Sign in with Google</h1>
                    </div>
                    </button>
                    <button onClick={()=>{signIn()}}>
                    <div className="flex w-44 h-8 bg-white border rounded-lg p-2 mt-5 ml-7">
                        <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-4">
                        ...
                        <h1 className="ml-2 text-xs text-slate-400">Sign in with Apple</h1>
                    </div>
                    </button>
                    </div>
                    <div className="w-96 h-72 bg-white border rounded-xl mt-5 py-5 px-6 text-left">
                        <div>
                            <h1 className="font-normal">Email address</h1>
                            <input type="text" className="w-80 h-9 border bg-slate-200 rounded-lg mt-2 pl-3 font-medium text-lg" ></input>
                        </div>
                        <div className="mt-5">
                            <h1 className="font-normal">Password</h1>
                            <input type="password" className="w-80 h-9 border bg-slate-200 rounded-lg mt-2 pl-3 font-normal text-lg" ></input>
                        </div>
                        <div className="mt-3">
                            <a href="#" className="text text-cyan-600">Forgot password?</a>
                        </div>
                        <div className="mt-3">
                            <button className="w-80 h-10 border rounded-xl bg-black"><h1 className="text-white font-normal text-lg">Sign In</h1></button>
                        </div>
                    </div>
                </div>
            </div>
